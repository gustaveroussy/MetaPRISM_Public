...
def draw_double_heatmap_drugs(df_drug, col_drug):
    ...
    config.heatmap["orientation"] = "antidiagonal"
    config.heatmap["ticks_labelsize"] = "7"
    ...
    config.test["fwer_size"] = 15
    config.test["fdr_size"] = 3
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_barplot', type=str, help='Path to output barplot.',
                        default="../../../results/data_overview/treatments/barplots/LUAD_Classes.pdf")
    parser.add_argument('--output_dbl_htp', type=str, help='Paths to output double heatmap plot.',
                        default="../../../results/data_overview/treatments/double_heatmap/LUAD_Classes.pdf")
    parser.add_argument('--output_comut', type=str,  help='Paths to output oncoplot-like.',
                        default="../../../results/data_overview/treatments/comuts/LUAD_Classes.pdf")
